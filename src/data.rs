...
pub fn fetch_products(_settings: &Settings) -> Vec<Product> {
    vec![
        Product {
            ...
            image: "https://placehold.co/400x400/1a1a2e/ffffff?text=Samsung+QLED+TV".to_string()
        },
        Product {
            id: 2,
            ...
            image: "https://placehold.co/400x400/f5f5f5/1a1a1a?text=MacBook+Air+M2".to_string()
        },
        Product {
            id: 3,
            ...
            image: "https://placehold.co/400x400/2d2d2d/ffffff?text=Sony+WH-1000XM5".to_string()
        },
        Product {
            id: 4,
            ...
            image: "https://placehold.co/400x400/4a4a4a/ffffff?text=iPhone+15+Pro".to_string()
        },
        Product {
            id: 5,
            ...
            image: "https://placehold.co/400x400/003791/ffffff?text=PlayStation+5".to_string()
        },
        Product {
            id: 6,
            ...
            image: "https://placehold.co/400x400/d1d1d6/1a1a1a?text=iPad+Pro+12.9".to_string()
        },
        Product {
            id: 7,
            ...
            image: "https://placehold.co/400x400/1c1c1c/ffffff?text=Galaxy+S24+Ultra".to_string()
        },
        Product {
            id: 8,
            ...
            image: "https://placehold.co/400x400/f0ede8/1a1a1a?text=Bose+QC+Ultra".to_string()
        },
        Product {
            id: 9,
            ...
            image: "https://placehold.co/400x400/e4000f/ffffff?text=Nintendo+Switch".to_string()
        },
        Product {
            id: 10,
            ...
            image: "https://placehold.co/400x400/007db8/ffffff?text=Dell+27+Monitor".to_string()
        }
    ]
}