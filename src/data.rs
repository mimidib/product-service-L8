...
pub fn fetch_products(_settings: &Settings) -> Vec<Product> {
    vec![
        Product {
            ...
            image: "/images/samsung-tv.jpg".to_string()
        },
        Product {
            id: 2,
            ...
            image: "/images/macbook-air-m2.jpg".to_string()
        },
        Product {
            id: 3,
            ...
            image: "/images/sony-wh1000xm5.jpg".to_string()
        },
        Product {
            id: 4,
            ...
            image: "/images/iphone-15-pro.jpg".to_string()
        },
        Product {
            id: 5,
            ...
            image: "/images/ps5.jpg".to_string()
        },
        Product {
            id: 6,
            ...
            image: "/images/ipad-pro.jpg".to_string()
        },
        Product {
            id: 7,
            ...
            image: "/images/galaxy-s24-ultra.jpg".to_string()
        },
        Product {
            id: 8,
            ...
            image: "/images/bose-qc-ultra.jpg".to_string()
        },
        Product {
            id: 9,
            ...
            image: "/images/nintendo-switch-oled.jpg".to_string()
        },
        Product {
            id: 10,
            ...
            image: "/images/dell-monitor.jpg".to_string()
        }
    ]
}